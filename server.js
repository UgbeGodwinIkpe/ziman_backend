...
// app.use(cors());
app.use(cors({
  origin: ['*','http://127.0.0.1:5500','http://localhost:61142', 'http://localhost:57025', 'https://ziman.com.ng', 'http://localhost:55128', 'http://localhost:64823', 'http://localhost:51294', 'http://localhost:52212', 'https://ziman.com.ng', 'https://www.ziman.com.ng'], // Allow this origin
