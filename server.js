...
// app.use(cors());
app.use(cors({
  origin: ['*','http://127.0.0.1:5500','http://localhost:62087', 'http://localhost:57025', 'https://ziman.com.ng', 'http://localhost:55128', 'http://localhost:64823', 'http://localhost:49245'], // Allow this origin
